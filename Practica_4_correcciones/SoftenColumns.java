 ...
 * Las columnas de la imagen se reparten secuencialmente entre los hilos.
 * <p>
 * Recibe como parametros el filtro y el numero de hilos.
 * @author Iago Fernandez Gonzalez
 * @version 1.0
 */
public class SoftenColumns {
    ...
    static class myThread implements Runnable{
        ...
        // Recorre el array por columnas secuencialmente suavizando la imagen.
        public void run(){
            ...
            for(int j=current; j<height; j+=hilos) {
                for(int i=0; i < width; i++) {
                    sumatorio = 0;
