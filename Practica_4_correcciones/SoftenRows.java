 ...
 * Las filas de la imagen se reparten secuencialmente entre los hilos.
 * <p>
 * Recibe como parametros el filtro y el numero de hilos.
 * @author Iago Fernandez Gonzalez
 * @version 1.0
 */
public class SoftenRows {
    ...
    static class myThread implements Runnable{
        ...
        // Recorre el array por filas secuencialmente suavizando la imagen.
        public void run(){
            ...
            for(int i=current; i<width; i+=hilos) {
                for(int j=0; j<height; j++) {
                    sumatorio = 0;
